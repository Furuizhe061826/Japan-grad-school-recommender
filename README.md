...
一个用于简历和作品集展示的 Next.js MVP。用户填写本科院校背景、研究方向、GPA、语言成绩和申请偏好后，系统会基于本地研究科/方向 JSON 数据与规则算法，生成「冲刺 / 匹配 / 相对稳妥」三档日本大学院推荐结果。用户也可以填写“意向院校”，系统会单独判断该目标学校的申请可行性，并给出校内更匹配的项目方向、潜在教授/研究室、风险点和准备建议。
